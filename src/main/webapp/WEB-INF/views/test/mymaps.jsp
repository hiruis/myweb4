...
<body>
	...
	<div id="map" style="width: 500px; height: 300px;">
		...
		<script type="text/javascript">
			...
			var infoWindows = [];
			var i = 0;
			<c:forEach items="${mapslist}" var="mapslists" >
			
			var name = '${mapslists.name}';
			var lat = '${mapslists.lat}';
			var lng = '${mapslists.lng}';
			var addr = '${mapslists.addr}';
			...
			var contentString = [
					'<div class=""style="cursor:pointer;"onClick="gopage(${mapslists.idx})">',
