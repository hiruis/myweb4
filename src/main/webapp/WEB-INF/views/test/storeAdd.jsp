...
<body>
	<form name="addfm" action="storeAdd.do" method="POST">
		<table border="1" style="width: 500px; height: 700px;">
			...
			<tr>
				<td colspan="2"><input id="address" type="text"
					placeholder="검색할 주소" value=""> <input id="submit"
					type="button" value="검색"> <label style="margin-left: 20px;"><b
						id="serchtxt"> </b></label></td>
			</tr>
			<tr>
				<td colspan="2"><input id="lat" type="hidden" name="lat"><input id="lng" type="hidden" name="lng"></td>
			</tr>
